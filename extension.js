        ...
        name: "舰R牌将", content: function (config, pack) {
                            ...
                            "fangkong2": {
                                ...
                                content: function () {
                                    ...
                                    if (result.bool) {//只能判断你有没有选择，然后给你true与false，没其他文本。
                                        ...
                                        if (player.hasSkill('duikongfangyu')) player.draw(2);//对空防御的技能效果。若玩家拥有对空防御，则发动防空后可以摸牌。
                                    }//让技能发语音，发历史记录。
                                },
                                subSkill: {
                                    d: {
                            ...
                            sawohaizhan_1: {
                                mod: {
                                    cardUsable: function (card) {
                                        if ((card.name == 'sha' || card.name == 'sheji9')/*&& card.nature == 'thunder'*/) return Infinity;
                                    },
                                    targetInRange: function (card) {
                                        if ((card.name == 'sha' || card.name == 'sheji9')/*&& card.nature == 'thunder'*/) return true;
                                    },
                                },
                                trigger: {
                                    player: "useCard",
                                ...
                                forced: true,
                                filter: function (event, player) {
                                    return event.card && ((event.card.name == 'sha' || event.card.name == 'sheji9') && event.card.nature == 'thunder');
                                },
                                content: function () {
                                    trigger.baseDamage++;
                                },
            ...
            return false;*/
                        ...
                        translate: {
                            ...
                            duikongfangyu: "对空防御", "duikongfangyu_info": "你受到万箭齐发和近距支援伤害时，你防止此伤害。你发动[防空]后，你摸2张牌",
