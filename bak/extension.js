...
import { weightedRandom,probeJianRAssetExt } from "./utils.js";
...
game.import("extension", function (lib, game, ui, get, ai, _status) {
    ...
    return {
        ...
        content: function (config, pack) {
            ...
            async function getMissionImageExt(skinName) {
                if (isImportedMode) {
                ...
                // 目录模式：同步 fs 探测，png/jpg 都支持
                var extName = await probeJianRAssetExt('image/character/' + skinName) || '.jpg';
                return extName;
            }
        ...
        precontent: function () {
            ...
            var getJianRCharacterImageRelativePath = async function (characterName) {
                ...
                var probedExt = await probeJianRAssetExt(jianrExtensionDirectoryName, 'image/character/' + characterName) || '.jpg';
            ...
            var normalizeJianRDirectoryAssetReference = function (value) {
                ...
                return value.split('ext:' + jianrExtensionDirectoryName + '/').join('ext:' + jianrExtensionDirectoryName + '/');
            };
            ...
            game.import('character', function () {
                ...
                for (var i in jianrjinji.character) {
                    ...
                    getJianRCharacterImageTag(i).then(function (tag) {
                        console.log(tag);
                        jianrjinji.character[i][4].push(tag);
                    })
